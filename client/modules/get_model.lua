...
local hash_to_ped = {}
for i,v in ipairs(peds_list) do
	hash_to_ped[GetHashKey(v)] = v
end

AddEventHandler("exp_target_menu:GetModel", function(entity)
    print(hash_to_ped[GetEntityModel(entity)] or GetEntityModel(entity))
end)
TriggerEvent("exp_target_menu:AddTypeMenuItem", "exp_target_menu:GetModel", "ped", "Get Model", false)

RegisterCommand("model", function()
	TriggerEvent("exp_target_menu:model", function(entity)
